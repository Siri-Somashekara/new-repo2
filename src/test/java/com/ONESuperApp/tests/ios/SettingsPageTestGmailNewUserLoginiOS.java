...
public class SettingsPageTestGmailNewUserLoginiOS extends AppiumBaseClass{
	...
	@Test(priority = 6)
	public void newUserGmailLoginTest() throws InterruptedException, IOException
	{
		settingspageiOS.newUserGmailLoginiOS();
	}
