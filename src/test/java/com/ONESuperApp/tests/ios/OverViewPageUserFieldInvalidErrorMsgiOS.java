...
public class OverViewPageUserFieldInvalidErrorMsgiOS extends AppiumBaseClass {
	...
	public void userDetailInvalidFieldErrorMsgTest() throws IOException, InterruptedException
	{
		...
		String emailField = overviewpageiOS.emailInvalidFieldErrorMsgiOS();
		Assert.assertEquals(emailField, overviewpageiOS.expEmailInvalidFieldErrorMsg);
		String phoneNoField = overviewpageiOS.phoneNoFieldInvalidErrorMsgiOS();
		Assert.assertEquals(phoneNoField, overviewpageiOS.expPhoneNoFieldInvalidErrorMsg);
		String userHandle = overviewpageiOS.userHandleInvalidFieldErrorMsgiOS();
		Assert.assertEquals(userHandle, overviewpageiOS.expUserHandleInvalidFieldErrorMsg);
