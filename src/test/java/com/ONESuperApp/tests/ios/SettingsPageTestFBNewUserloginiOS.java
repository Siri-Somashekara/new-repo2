...
public class SettingsPageTestFBNewUserloginiOS extends AppiumBaseClass{
	...
	@Test(priority = 6)
	public void newUserFBLoginTest() throws InterruptedException, IOException
	{
		settingspageiOS.newUserFBLoginiOS();
	}
