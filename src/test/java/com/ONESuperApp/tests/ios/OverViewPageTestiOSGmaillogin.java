...
public class OverViewPageTestiOSGmaillogin extends AppiumBaseClass {
...
/*	@Test(priority = 8)
	...
	public void submitFeedbackTest() throws InterruptedException
	{
		...
		//Assert.assertEquals(feedbacktoastmsg, "Thanks for your feedback!");
	}
	...
	/*	@Test(priority = 13)
		public void selectAthletesTest() throws InterruptedException 
		{
			...
			Assert.assertEquals(selectathletes, "Select Athletes");
		}
	*/
		@Test(priority = 15)
