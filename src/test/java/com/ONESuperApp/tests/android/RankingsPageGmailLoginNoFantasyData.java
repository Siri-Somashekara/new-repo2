...
public class RankingsPageGmailLoginNoFantasyData extends AppiumBaseClass{
	...
	{
		rankingspage.newUserGmailLoginEmptyFantasyRank();
	}

	@Test(priority = 7)
	public void noFatnasyListTest()
	{
		String noFantasyList = rankingspage.noFantasyList();
		Assert.assertEquals(noFantasyList, rankingspage.expNoFantasyList);
	}
