...
public class OverViewPageTestNewGmailUser extends AppiumBaseClass {
	...
	@Test(priority = 5)
	public void newGmailLoginTest() throws IOException, InterruptedException
	{
		overviewpage.newUserGmailLogin();
	}
