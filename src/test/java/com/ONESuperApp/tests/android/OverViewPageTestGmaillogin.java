...
public class OverViewPageTestGmaillogin extends AppiumBaseClass {
	...
	{
		String feedbackpagetitletext = overviewpage.SubmitFeedback();
		Assert.assertEquals(feedbackpagetitletext, overviewpage.expFeedbackPageTitleText);
