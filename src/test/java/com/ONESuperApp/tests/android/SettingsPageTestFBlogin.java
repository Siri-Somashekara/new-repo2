...
public class SettingsPageTestFBlogin extends AppiumBaseClass 
{
	...
	{
		settingspage.fbLogin();
	}
	
	@Test(priority=7)
	public void SettingsTabHeaderTest() throws InterruptedException
	{
		String settingtabheader=settingspage.TabHeader();
		Assert.assertEquals(settingtabheader, settingspage.expSettingTabHeaderTitleText);
	}
