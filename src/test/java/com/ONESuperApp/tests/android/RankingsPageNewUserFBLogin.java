...
public class RankingsPageNewUserFBLogin extends AppiumBaseClass{
	...
	{
		String Header=overviewpage.ProfileHeader();
		Assert.assertEquals(Header, overviewpage.expProfilePageHeader);
	}
